  ...
  plugins: [
    {
      ...
      options: {
        publisherId: `ca-pub-6909272605225061`
      },
    },
    {
      ...
      options: {
        ...
        trackingIds: [
          "G-T71K072LJX", // Google Analytics / GA / default subdomain
          "G-XZLM68XSBV", // Google Analytics / GA / custom subdomain blog.techhackswithash.com
